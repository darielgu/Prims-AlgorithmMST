...
int main() {
    ...
    //"input.txt was throwing error so had to change to my absolute path"
    if (!graph.loadGraphFromFile("/Users/darielgutierrez/Desktop/CS 210/LastName_FirstNamePrim/input.txt")) {
